...
class FinanceTracker 
    def __init__(self):
      ...
      self.monthly_data = defailtdict(lambda) 

    def load.csv(self, filename):
   ...
   def _parse_transation(self, row):
       ...
       try:
            ...
            description = row.get(desc_col, 'Unknown').strip() if desc_col 'Unknwon'
